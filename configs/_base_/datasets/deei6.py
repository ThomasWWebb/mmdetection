...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/deei6_fc_train.json',
        img_prefix=data_root + 'train/deei6_fc/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/deei6_fc_val.json',
        img_prefix=data_root + 'val/deei6_fc/',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/deei6_fc_test.json',
        img_prefix=data_root + 'test/deei6_fc/',
        pipeline=test_pipeline))
